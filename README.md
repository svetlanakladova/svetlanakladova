...
### [Data Analytics Portfolio](https://github.com/svetlanakladova/analytics_projects)

### Skills:

**Analytics & Product**
`Funnel Analysis` `Retention Analysis` `Cohort Analysis`  
`A/B Testing` `Unit Economics` `Product Metrics` `Data Quality`
